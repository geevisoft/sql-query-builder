 ...
 */
public class JoinQuery extends WhereQuery {
    ...
    public JoinQuery rightJoin(String table, String clause){
        return rightJoin().join(table, clause);
    }

    public JoinQuery rightJoin(String table, String oneColumn, String anotherColumn){
        return rightJoin().join(table, oneColumn, anotherColumn);
    }

    public JoinQuery rightJoin(String table, String oneColumn, String anotherColumn, String otherClauses){
